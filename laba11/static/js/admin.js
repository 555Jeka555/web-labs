...
function loadImage(event) {
    ...
    reader.onload = () => {
        ...
        for (let divHeroImg of divHeroImgs) {
            ...
            inputChangeAuthorPhoto.removeEventListener('change', loadImage);
            inputChangeAuthorPhoto.addEventListener('change', loadImage);
        ...
        if (trash !== null) {
            trash.removeEventListener('click', removeImage);
...
function removeImage() {
    ...
    inputChangeImg.removeEventListener('change', loadImage);
    inputChangeImg.addEventListener('change', loadImage);
...
function loadAvatar(event) {
    ...
    reader.onload = () => {
        ...
        inputChangeAuthorPhoto.removeEventListener('change', loadAvatar);
        inputChangeAuthorPhoto.addEventListener('change', loadAvatar);
        divChangeInput.appendChild(inputChangeAuthorPhoto);
        ...
        if (trashAvatar !== null) {
            trashAvatar.removeEventListener('click', removeAvatar);
